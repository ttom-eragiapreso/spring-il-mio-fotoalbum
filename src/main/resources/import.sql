INSERT INTO db_photoalbum.photos (description, is_visible, title, url) VALUES('Description 1', 1, 'Photo 1','https://picsum.photos/200/300');
INSERT INTO db_photoalbum.photos (description, is_visible, title, url) VALUES('Description 2', 1, 'Photo 2','https://picsum.photos/200/300');
INSERT INTO db_photoalbum.photos (description, is_visible, title, url) VALUES('Description 3', 1, 'Photo 3','https://picsum.photos/200/300');
INSERT INTO db_photoalbum.photos (description, is_visible, title, url) VALUES('Description 4', 1, 'Photo 4','https://picsum.photos/200/300');
INSERT INTO db_photoalbum.photos (description, is_visible, title, url) VALUES('Description 5', 1, 'Photo 5','https://picsum.photos/200/300');
